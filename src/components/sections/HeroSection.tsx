...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-white overflow-hidden" role="banner" aria-labelledby="page-title">
      <div className="absolute inset-0 z-0">
        <img 
          src="/lovable-uploads/cc6e1f8b-fd0d-41c3-9bf5-1ab95736be0a.png" 
          alt="A minimalist white background with diagonal lines" 
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <h1 id="page-title" className="font-playfair text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900 mb-8 animate-fade-up">
          Brand Strategy
        </h1>
        ...
        <a 
          ...
          aria-label="Explore more about brand strategy"
        >
          Explore More
        </a>
      </div>
