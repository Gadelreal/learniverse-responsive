        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg opacity-0 translate-y-10 scroll-animate shadow-sm">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              ...
              <ul className="space-y-4 font-inter text-gray-600 opacity-0 translate-y-10 scroll-animate">
